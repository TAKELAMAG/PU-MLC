...
def get_data_path(dataset, dataPath):
...
def get_data_loader(args):
    ...
    test_dir, test_anno, test_label = get_data_path(args.dataset, args.data)
    ...
    print("len(val_dataset)): ", len(test_set))
    print("len(train_dataset)): ", len(train_set))
